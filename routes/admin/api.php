...
Route::group(['prefix' => 'settings', 'namespace' => 'Api\Settings', 'as' => 'api.settings.'], function () {
    ...
    Route::get('configuration', 'ConfigurationController@index')->name('configurations.index');
    Route::put('configuration/update', 'ConfigurationController@update')->name('configurations.update');
