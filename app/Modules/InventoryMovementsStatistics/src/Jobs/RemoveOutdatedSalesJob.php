        ...
        collect(DB::select('
            WITH tempTable AS (
                SELECT
                  ...
                  min(inventory_movements_statistics.last7days_min_movement_id) as current_first_movement_id,
                ...
                INNER JOIN inventory_movements
                 ...
                 AND inventory_movements.id >= inventory_movements_statistics.last7days_min_movement_id
                 AND inventory_movements.created_at < date_sub(now(), interval 7 day)
                WHERE inventory_movements_statistics.last7days_min_movement_id IS NOT NULL
            ...
            SET
              ...
              last7days_quantity_delta = last7days_quantity_delta - sum_quantity_delta
        '));
    }
}
