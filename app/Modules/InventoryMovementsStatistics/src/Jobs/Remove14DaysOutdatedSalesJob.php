 ...
 *
 */
class Remove14DaysOutdatedSalesJob implements ShouldQueue
{
    use Dispatchable;
    ...
    public function handle()
    {
        DB::statement("
            ...
            SET quantity_sold_last_14_days = 0,
                updated_at = now()
            WHERE last_sold_at < DATE_SUB(now(), INTERVAL 14 DAY)
            AND IFNULL(quantity_sold_last_14_days, 0) != 0
        ");
