...
class QuantityBeforeJobCopy extends UniqueJob
{
        ...
        do {
            ...
            $recordsUpdated = DB::update('
                ...
                SET
                    ...
                    inventory_movements.quantity_delta = CASE WHEN inventory_movements.type = "stocktake"
                            THEN inventory_movements.quantity_delta - tbl.quantity_before_delta
                            ElSE inventory_movements.quantity_delta
                            END,

                    inventory_movements.quantity_after = CASE WHEN inventory_movements.type = "stocktake"
