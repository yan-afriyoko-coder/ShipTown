...
class RestockingReport extends Report
{
    public function __construct(array $attributes = [])
    {
        ...
        $this->fields = [
            ...
            'quantity_to_ship'                   => DB::raw('CASE WHEN inventory_source.quantity_available < inventory.quantity_requiredñ THEN inventory_source.quantity_available ELSE inventory.quantity_required END as quantity_to_ship'),
        ];
