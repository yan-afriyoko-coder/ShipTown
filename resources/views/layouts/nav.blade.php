                ...
                <ul class="navbar-nav mr-auto text-center text-md-left">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('ready_order_shipments_as_csv').'?include=order&filter[shipping_number]=LJ&filter[order.status_code]=ready&fields=shipping_number,order.order_number&filename=AnPost_ready_shipments.cs'}}" target="_blank">{{ __("Download AnPost Shipments") }}</a>
                            <a class="dropdown-item" href="{{ route('ready_order_shipments_as_csv').'?include=order&filter[shipping_number]=8543&filter[order.status_code]=ready&fields=id,shipping_number,order.order_number&filename=dpd_ready_shipments.csv'}}" target="_blank">{{ __("Download DPD Shipments") }}</a>
