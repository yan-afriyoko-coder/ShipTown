                ...
                <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <div class="dropdown position-static">
                        ...
                        <div class="dropdown-menu dropdown-menu-right w-100 text-center bg-primary" aria-labelledby="navbarDropdown" >
                            ...
                            <a class="btn btn-primary d-block" href="{{ route('reports.restocking' , ['filter[warehouse_quantity_between]' => '0.01,9999999', 'sort' => '-quantity_required']) }}">{{ __('Restocking') }}</a>
                ...
                <ul class="navbar-nav mr-auto text-center text-md-left">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu left bg-primary" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item text-white lightHover" href="{{ route('fulfilment-dashboard') }}">{{ __('Fulfilment Dashboard') }}</a>
                            <a class="dropdown-item text-white lightHover" href="{{ route('performance.dashboard') .'?between_dates=-7days,now' }}">{{ __('Fulfilment Performance') }}</a>
