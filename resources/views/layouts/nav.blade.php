                ...
                <ul class="navbar-nav mr-auto text-center text-md-left">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('ready_order_shipments_as_csv').'?include=order&filter[order.status_code]=ready&fields=shipping_number,order.order_number&filename=AnPost_Ready_Shipments'}}" target="_blank">{{ __("Download AnPost Shipments") }}</a>
                            <a class="dropdown-item" href="{{ route('ready_order_shipments_as_csv').'?include=order&filter[order.status_code]=ready&fields=id,shipping_number,order.order_number&filename=DPD_Ready_Shipments'}}" target="_blank">{{ __("Download DPD Shipments") }}</a>
